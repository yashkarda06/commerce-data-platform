...
def log_run(spark, notebook_name, environment, run_mode, start_time, end_time, rows_processed, status,audit_path, error_message=None):
    ...
    write_delta(df,f"{audit_path}/pipeline_runs","append")
